...
type ComplexityRoot struct {
	...
	Mutation struct {
		...
		CreateCompany       func(childComplexity int, name string, photoURL *string) int
		CreateGroup         func(childComplexity int, name string, userIds []string) int
		DeleteUserFromGroup func(childComplexity int, userID string, groupID string) int
		ModifyGroupUsers    func(childComplexity int, groupID string, userIds []string) int
		PostMessage         func(childComplexity int, senderID string, receiverID *string, groupID *string, content string, mediaURL *string) int
	}

	Query struct {
		ChatMessages func(childComplexity int, userID string, since string) int
		GetUsers     func(childComplexity int, userID *string) int
		Group        func(childComplexity int, id string) int
		Messages     func(childComplexity int, userID string, since string) int
	}

	Subscription struct {
		NewMessages func(childComplexity int, userID string, since string) int
	}
...
type MutationResolver interface {
	PostMessage(ctx context.Context, senderID string, receiverID *string, groupID *string, content string, mediaURL *string) (*model.Message, error)
	CreateGroup(ctx context.Context, name string, userIds []string) (*model.Group, error)
	AddUserToGroup(ctx context.Context, userID string, groupID string) (*model.Group, error)
	DeleteUserFromGroup(ctx context.Context, userID string, groupID string) (*model.Group, error)
	ModifyGroupUsers(ctx context.Context, groupID string, userIds []string) (*model.Group, error)
	CreateCompany(ctx context.Context, name string, photoURL *string) (*model.Company, error)
}
type QueryResolver interface {
	Group(ctx context.Context, id string) (*model.Group, error)
	Messages(ctx context.Context, userID string, since string) ([]*model.Message, error)
	ChatMessages(ctx context.Context, userID string, since string) ([]*model.ChatMessages, error)
	GetUsers(ctx context.Context, userID *string) ([]*model.User, error)
}
type SubscriptionResolver interface {
	NewMessages(ctx context.Context, userID string, since string) (<-chan []*model.ChatMessages, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "ChatMessages.messages":
		if e.complexity.ChatMessages.Messages == nil {
			break
		}

		return e.complexity.ChatMessages.Messages(childComplexity), true

	case "ChatMessages.senderId":
		if e.complexity.ChatMessages.SenderID == nil {
			break
		}

		return e.complexity.ChatMessages.SenderID(childComplexity), true
	...
	case "Company.photoUrl":
		if e.complexity.Company.PhotoURL == nil {
			break
		}

		return e.complexity.Company.PhotoURL(childComplexity), true
	...
	case "Group.photoUrl":
		if e.complexity.Group.PhotoURL == nil {
			break
		}

		return e.complexity.Group.PhotoURL(childComplexity), true
	...
	case "Mutation.createCompany":
		...
		return e.complexity.Mutation.CreateCompany(childComplexity, args["name"].(string), args["photoUrl"].(*string)), true
	...
	case "Mutation.createGroup":
		...
		return e.complexity.Mutation.CreateGroup(childComplexity, args["name"].(string), args["userIds"].([]string)), true

	case "Mutation.deleteUserFromGroup":
		if e.complexity.Mutation.DeleteUserFromGroup == nil {
			break
		}

		args, err := ec.field_Mutation_deleteUserFromGroup_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.DeleteUserFromGroup(childComplexity, args["userId"].(string), args["groupId"].(string)), true

	case "Mutation.modifyGroupUsers":
		if e.complexity.Mutation.ModifyGroupUsers == nil {
			break
		}

		args, err := ec.field_Mutation_modifyGroupUsers_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.ModifyGroupUsers(childComplexity, args["groupId"].(string), args["userIds"].([]string)), true
	...
	case "Mutation.postMessage":
		...
		return e.complexity.Mutation.PostMessage(childComplexity, args["senderId"].(string), args["receiverId"].(*string), args["groupId"].(*string), args["content"].(string), args["mediaUrl"].(*string)), true
	...
	case "Query.ChatMessages":
		...
		return e.complexity.Query.ChatMessages(childComplexity, args["userId"].(string), args["since"].(string)), true
	...
	case "Query.GetUsers":
		...
		return e.complexity.Query.GetUsers(childComplexity, args["userId"].(*string)), true
	...
	case "Query.Messages":
		...
		return e.complexity.Query.Messages(childComplexity, args["userId"].(string), args["since"].(string)), true

	case "Subscription.NewMessages":
		if e.complexity.Subscription.NewMessages == nil {
			break
		}

		args, err := ec.field_Subscription_NewMessages_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Subscription.NewMessages(childComplexity, args["userId"].(string), args["since"].(string)), true
...
func (ec *executionContext) field_Mutation_deleteUserFromGroup_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["userId"]; ok {
...
func (ec *executionContext) field_Mutation_modifyGroupUsers_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["groupId"]; ok {
...
func (ec *executionContext) field_Subscription_NewMessages_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["userId"]; ok {
...
func (ec *executionContext) _ChatMessages_senderId(ctx context.Context, field graphql.CollectedField, obj *model.ChatMessages) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_ChatMessages_senderId(ctx, field)
	if err != nil {
		return graphql.Null
	}
...
func (ec *executionContext) fieldContext_ChatMessages_senderId(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
...
func (ec *executionContext) _ChatMessages_messages(ctx context.Context, field graphql.CollectedField, obj *model.ChatMessages) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_ChatMessages_messages(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	fc.Result = res
	return ec.marshalNMessage2ᚕᚖbluechatᚑserverᚋgraphᚋmodelᚐMessageᚄ(ctx, field.Selections, res)
}

func (ec *executionContext) fieldContext_ChatMessages_messages(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "ChatMessages",
		Field:      field,
		IsMethod:   false,
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "groupId":
				return ec.fieldContext_Message_groupId(ctx, field)
			case "content":
...
func (ec *executionContext) _Company_photoUrl(ctx context.Context, field graphql.CollectedField, obj *model.Company) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Company_photoUrl(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Company_photoUrl(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Company",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Group_photoUrl(ctx context.Context, field graphql.CollectedField, obj *model.Group) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Group_photoUrl(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Group_photoUrl(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Group",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Message_groupId(ctx context.Context, field graphql.CollectedField, obj *model.Message) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Message_groupId(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Message_groupId(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Message",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Message_mediaUrl(ctx context.Context, field graphql.CollectedField, obj *model.Message) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Message_mediaUrl(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Message_mediaUrl(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Message",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Mutation_postMessage(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().PostMessage(rctx, fc.Args["senderId"].(string), fc.Args["receiverId"].(*string), fc.Args["groupId"].(*string), fc.Args["content"].(string), fc.Args["mediaUrl"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*model.Message)
	fc.Result = res
	return ec.marshalOMessage2ᚖbluechatᚑserverᚋgraphᚋmodelᚐMessage(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_createGroup(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateGroup(rctx, fc.Args["name"].(string), fc.Args["userIds"].([]string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalOGroup2ᚖbluechatᚑserverᚋgraphᚋmodelᚐGroup(ctx, field.Selections, res)
}
...
func (ec *executionContext) fieldContext_Mutation_createGroup(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "photoUrl":
				return ec.fieldContext_Group_photoUrl(ctx, field)
			}
...
func (ec *executionContext) _Mutation_deleteUserFromGroup(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Mutation_deleteUserFromGroup(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().DeleteUserFromGroup(rctx, fc.Args["userId"].(string), fc.Args["groupId"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Mutation_deleteUserFromGroup(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_deleteUserFromGroup_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Mutation_modifyGroupUsers(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Mutation_modifyGroupUsers(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().ModifyGroupUsers(rctx, fc.Args["groupId"].(string), fc.Args["userIds"].([]string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Mutation_modifyGroupUsers(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_modifyGroupUsers_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Mutation_createCompany(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateCompany(rctx, fc.Args["name"].(string), fc.Args["photoUrl"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalOCompany2ᚖbluechatᚑserverᚋgraphᚋmodelᚐCompany(ctx, field.Selections, res)
}
...
func (ec *executionContext) fieldContext_Mutation_createCompany(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "photoUrl":
				return ec.fieldContext_Company_photoUrl(ctx, field)
			}
...
func (ec *executionContext) _Query_Messages(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Messages(rctx, fc.Args["userId"].(string), fc.Args["since"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_ChatMessages(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().ChatMessages(rctx, fc.Args["userId"].(string), fc.Args["since"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNChatMessages2ᚕᚖbluechatᚑserverᚋgraphᚋmodelᚐChatMessagesᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) fieldContext_Query_ChatMessages(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "senderId":
				return ec.fieldContext_ChatMessages_senderId(ctx, field)
			case "messages":
				return ec.fieldContext_ChatMessages_messages(ctx, field)
			}
...
func (ec *executionContext) _Query_GetUsers(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetUsers(rctx, fc.Args["userId"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNUser2ᚕᚖbluechatᚑserverᚋgraphᚋmodelᚐUserᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Subscription_NewMessages(ctx context.Context, field graphql.CollectedField) (ret func(ctx context.Context) graphql.Marshaler) {
	fc, err := ec.fieldContext_Subscription_NewMessages(ctx, field)
	if err != nil {
		return nil
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Subscription().NewMessages(rctx, fc.Args["userId"].(string), fc.Args["since"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return nil
	...
	return func(ctx context.Context) graphql.Marshaler {
		select {
		case res, ok := <-resTmp.(<-chan []*model.ChatMessages):
			if !ok {
				return nil
			}
			return graphql.WriterFunc(func(w io.Writer) {
				...
				w.Write([]byte{':'})
				ec.marshalNChatMessages2ᚕᚖbluechatᚑserverᚋgraphᚋmodelᚐChatMessagesᚄ(ctx, field.Selections, res).MarshalGQL(w)
				w.Write([]byte{'}'})
			})
		case <-ctx.Done():
			return nil
...
func (ec *executionContext) fieldContext_Subscription_NewMessages(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Subscription",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Subscription_NewMessages_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _ChatMessages(ctx context.Context, sel ast.SelectionSet, obj *model.ChatMessages) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "senderId":
			out.Values[i] = ec._ChatMessages_senderId(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "messages":
			out.Values[i] = ec._ChatMessages_messages(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
...
func (ec *executionContext) _Company(ctx context.Context, sel ast.SelectionSet, obj *model.Company) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "photoUrl":
			out.Values[i] = ec._Company_photoUrl(ctx, field, obj)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
...
func (ec *executionContext) _Group(ctx context.Context, sel ast.SelectionSet, obj *model.Group) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "photoUrl":
			out.Values[i] = ec._Group_photoUrl(ctx, field, obj)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
...
func (ec *executionContext) _Message(ctx context.Context, sel ast.SelectionSet, obj *model.Message) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "groupId":
			out.Values[i] = ec._Message_groupId(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "content":
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "deleteUserFromGroup":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_deleteUserFromGroup(ctx, field)
			})
		case "modifyGroupUsers":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_modifyGroupUsers(ctx, field)
			})
		case "createCompany":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
...
func (ec *executionContext) _Subscription(ctx context.Context, sel ast.SelectionSet) func(ctx context.Context) graphql.Marshaler {
	...
	case "NewMessages":
		return ec._Subscription_NewMessages(ctx, fields[0])
	default:
...
func (ec *executionContext) marshalNChatMessages2ᚕᚖbluechatᚑserverᚋgraphᚋmodelᚐChatMessagesᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.ChatMessages) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNChatMessages2ᚖbluechatᚑserverᚋgraphᚋmodelᚐChatMessages(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNChatMessages2ᚖbluechatᚑserverᚋgraphᚋmodelᚐChatMessages(ctx context.Context, sel ast.SelectionSet, v *model.ChatMessages) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNMessage2ᚕᚖbluechatᚑserverᚋgraphᚋmodelᚐMessageᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Message) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMessage2ᚖbluechatᚑserverᚋgraphᚋmodelᚐMessage(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMessage2ᚖbluechatᚑserverᚋgraphᚋmodelᚐMessage(ctx context.Context, sel ast.SelectionSet, v *model.Message) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNUser2ᚕᚖbluechatᚑserverᚋgraphᚋmodelᚐUserᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.User) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNUser2ᚖbluechatᚑserverᚋgraphᚋmodelᚐUser(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNUser2ᚖbluechatᚑserverᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOCompany2ᚖbluechatᚑserverᚋgraphᚋmodelᚐCompany(ctx context.Context, sel ast.SelectionSet, v *model.Company) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) marshalOGroup2ᚖbluechatᚑserverᚋgraphᚋmodelᚐGroup(ctx context.Context, sel ast.SelectionSet, v *model.Group) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) marshalOMessage2ᚖbluechatᚑserverᚋgraphᚋmodelᚐMessage(ctx context.Context, sel ast.SelectionSet, v *model.Message) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Message(ctx, sel, v)
